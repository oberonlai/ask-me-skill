...
- **Q5（單選）** 一頁式網站的段落，選一個最接近的組合？（每個組合都至少 6 個區塊，內容較完整）
  1. 標準完整版：開頭自我介紹＋關於我＋服務項目＋作品案例＋客戶評價＋聯絡方式（6 區，通用最百搭）
  2. 作品導向：開頭自我介紹＋關於我＋作品案例＋服務項目＋合作流程＋聯絡方式（6 區，適合展示作品、接案）
  3. 信任導向：開頭自我介紹＋關於我＋服務項目＋客戶評價＋常見問題＋聯絡方式（6 區，適合建立專業信任）
  4. 旗艦完整版：開頭＋關於我＋服務項目＋作品案例＋客戶評價＋常見問題＋合作流程＋聯絡方式（8 區，最完整）
